...
Rails.application.configure do
  ...
  config.action_mailer.default_url_options = { host: 'kongreif.com', protocol: 'https' }
  ...
  config.hosts << 'kongreif.onrender.com'
  config.hosts << 'kongreif.com'
  config.hosts << 'www.kongreif.com'
end
